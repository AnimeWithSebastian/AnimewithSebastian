...
MANIFEST = "cron_tracking/daily_combined/pending/batchB_20260902/run_manifest.json"
OUT_DIR = "cron_tracking/daily_combined/pending/batchB_20260902"
...
def render(pkg):
    ...
    lines.append(f"STYLE:   {pkg.get('video_style', 'Face-Cam Split Screen')}")
